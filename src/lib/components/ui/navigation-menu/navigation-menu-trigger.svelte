...
>
	...
	<HugeiconsIcon
		...
		strokeWidth={2}
		class="transitiongroup-data-popup-open/navigation-menu-trigger:rotate-180 relative top-px ml-1 size-3 group-data-open/navigation-menu-trigger:rotate-180"
		aria-hidden="true"
	/>
</NavigationMenuPrimitive.Trigger>
